...
class RestaurantList extends Component {
      ...
      return (
        <View>
          ...
          >
            ...
            />
            <BR />
            <PrimaryText>{"We couldn't find anything."}</PrimaryText>
            <BR />
            <PrimaryText>Please try again...</PrimaryText>
          </View>
        </View>
      );
    }
    ...
    if (restaurant) {
      return (
        <RestaurantItem
          ...
          onPress={
            () => this.props.restaurantInfoScreenHandler(restaurant)
  ...
  render() {
    return this.renderRestaurantSection();
  }
}
